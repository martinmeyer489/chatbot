...
AS $$
DECLARE
  project_url TEXT := 'https://yofklvzntpfgzmpvknca.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InlvZmtsdnpudHBmZ3ptcHZrbmNhIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcwNTgzMzkxNywiZXhwIjoyMDIxNDA5OTE3fQ.GWFe6IIQWGrdwVY6EkFu3WjrH9AH4ml2_bniG3dSzwc'; -- full access needed for http request to storage
